...
export function WorkspaceIntegrationsClient({ workspace, integrationStatus }: Props) {
  ...
  const telegramWebhookUrl = `${DOMAIN}/api/webhooks/telegram/${workspace.id}`;
  const whatsappWebhookUrl = `${DOMAIN}/api/webhooks/whatsapp/${workspace.id}`;
