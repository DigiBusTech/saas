...
export default async function DashboardLayout({
  ...
  // Build workspace-scoped nav items — the first workspace is the default context
    ...
    <div className="min-h-screen bg-zinc-950 text-gray-300 flex">
      ...
      <aside className="w-60 bg-zinc-950/80 backdrop-blur-md border-r border-white/5 flex flex-col shrink-0">
        ...
        <div className="h-14 border-b border-white/5 flex items-center px-4 gap-2.5">
          <div className="bg-gradient-to-br from-cyan-400 to-blue-500 h-7 w-7 rounded-sm flex items-center justify-center font-bold text-slate-950 shadow-lg shadow-cyan-500/20 text-[10px]">
            SB
          </div>
        ...
        <div className="border-t border-white/5 p-3 space-y-2">
          <div className="flex items-center gap-2 px-2">
            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-indigo-500/20 to-purple-600/20 border border-indigo-500/20 flex items-center justify-center text-[9px] font-bold text-indigo-400">
